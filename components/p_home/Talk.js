  ...
  return (
    <section>
      ...
      <div className={s.imgs}>
        <Link href="/course/detail/[id]" as={`/course/detail/${recommendObj.left?.courseId}`}>
          <div className={s.left}>
            <img src={recommendObj.left?.img} alt={recommendObj.left?.title} />
          </div>
        </Link>
        <div className={s.right}>
          <Link href="/course/detail/[id]" as={`/course/detail/${recommendObj.rightTop?.courseId}`}>
          ...
          <div className={s.item} key={item?.courseId}>
            ...
            <div className={s.footer}>
              <div className={s.teacher}>
                <img src={item?.teacher?.img || '/img/teacher1.png'} alt="teacher_avatar" />
